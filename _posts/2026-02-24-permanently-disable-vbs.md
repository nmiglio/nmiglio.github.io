...
So why would you think about disabling it? Well.. **Virtualization Based Security can slow apps (and games) down by 5 to 15%**. So let's disable it. Should be an easy toggle to switch somewhere.. Well here is where the fun beginn.
